...
`WEB` · `API` · `MOBILE` · `CLOUD` · `OFFENSIVE SECURITY`
...
<img src="https://img.shields.io/badge/RESUME-111111?style=for-the-badge" alt="Resume">
</a>
...
<img src="https://img.shields.io/badge/TRYHACKME-111111?style=for-the-badge" alt="TryHackMe">
</a>
...
Security practitioner focused on **identifying, validating, and understanding
vulnerabilities** across modern applications and infrastructure.

My work spans **web applications, APIs, mobile applications, cloud environments,
and security operations**, with an emphasis on manual validation, reproducible
evidence, realistic impact assessment, and actionable remediation.
